...
export function ScreenshotButton({ screenshot, onScreenshotTook }: ScreeshotButtonProps) {
  ...
  async function handleTakeScreenshot() {
    ...
    // console.log(base64image); // da para salvar isso em um banco
  ...
  return (
    <button type="button"
      ...
      className="p-2 bg-zinc-800 rounded-md border-transparent hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500"
    >
